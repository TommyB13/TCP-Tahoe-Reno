...
def main():
    ...
    print(f'receiver is ready to receive on port {receiver_port}')
    while True:
        connection_socket, addr = receiver_socket.accept()
        ...
        try:
            ...
            print(Fore.CYAN + "Connection closed with sender." + Style.RESET_ALL)
